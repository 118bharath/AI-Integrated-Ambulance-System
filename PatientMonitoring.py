...
main = tkinter.Tk()
main.title("Revolutionizing Emergency Healthcare in Developing India: An AI-Integrated Ambulance System for Timely Intervention in Critical Conditions")
...
font = ('times', 16, 'bold')
title = Label(main, text="Revolutionizing Emergency Healthcare in Developing India: An AI-Integrated Ambulance System for Timely Intervention in Critical Conditions")
